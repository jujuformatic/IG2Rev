...
<body onload="InitiateSubjects()" id="body">
    ...
    <div id="subject-menu">
        <div id="delete-button" class="subject-menu-item">
            <img src="ressources/trash.png">
            <b>Supprimer</b>
        </div>
        <div id="edit-button" class="subject-menu-item">
            <img src="ressources/edit.png">
            <b>Modifier</b>
        </div>
        <div id="train-button" class="subject-menu-item">
            <b>Entrainement</b>
        </div>
        <div id="add-button" class="subject-menu-item">
