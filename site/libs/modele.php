...
function UpdateLessonDesc($id, $newtext)
{

    $sql = "UPDATE Lessons SET Description = '$newtext' WHERE Id='$id';";
    SQLUpdate($sql);
}

function UpdateLessonTitle($id, $newtext)
{

    $sql = "UPDATE Lessons SET Title = '$newtext' WHERE Id='$id';";
    SQLUpdate($sql);
}
...
function DeleteQPracticeById($idlesson)
{

    $sql = "DELETE FROM Practices WHERE lesson='$idlesson';";
    SQLDelete($sql);
}
...
function DeleteTeamsLessonLinksByLesson($idlesson)
{

    $sql = "DELETE FROM Teams_Lesson_Links WHERE Lesson='$idlesson' ;";
    SQLDelete($sql);
}
